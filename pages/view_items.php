...
$id=$_GET['id'];
$sql = "SELECT insert_info.*, products.product_name 
FROM insert_info 
JOIN products ON insert_info.item_id = products.id 
WHERE insert_info.insert_id = $id;";
  ...
  <section class="intro">
    <div class="container mt-5 ">
      <div class="row justify-content-center">
        ...
        <a class="btn btn-lg btn-primary my-2" href="view_insert.php">رجوع</a>
          <table class="table table-striped mb-0 table-bordered">
            ...
            <tbody>
              ...
              <td colspan="3"></td>
              <td> <h4>المجموع الاجمالي :  <?php echo getSum('insert_info','allPrice',$id) ?></h4></td>
              <td></td>
            </tr>
